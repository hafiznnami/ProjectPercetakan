            ...
            <div id="page-inner">
			 <div class="row">
                    <h1 class="page-header">
                            Produksi <small>Percetakan Kieta</small>
                        </h1>
                         <div class="col-md-12">
                        <h1><small>Form Produksi</small></h1><br>
                        <div class="form-row">
                        <div class="form-group col-md-4">
                          <label for="inputProduksi">ID Produksi</label>
                          <input type="text" class="form-control" id="inputProduksi" name="idProduksi">
                        </div>
                        <div class="form-group col-md-4">
                          <label for="inputPesanan">No Pesanan</label>
                          <input type="text" class="form-control" id="inputPesanan" name="noPesanan">
                        </div>
                        <div class="form-group col-md-4">
                          <label for="tanggal1">Tanggal Produksi</label>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <button type="submit" id="tambahProduksi" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> Tambah</button>
                        </div>
                         </div>
                        </div>
                        <div class="col-md-12">
                        <h1><small>Data Produksi</small></h1><br>
                        <div id="produksi"></div> 
                        </div>
                     </div>
                    </div> 
