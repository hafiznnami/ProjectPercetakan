			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Tambah Print <small>Percetakan Kieta<small>
                        </h1>
                        <div class="panel panel-default">
					<div class="panel-body">
						<label>ID</label>
						<input type="text" id="idPrint" class="form-control form-control-sm">
						<label>Produk</label>
						<input type="text" id="idProduk" class="form-control form-control-sm">
						<label>Ukuran</label>
						<input type="text" id="ukuranPrint" class="form-control form-control-sm">
                        <label>Warna</label>
                        <input type="text" id="warnaPrint" class="form-control form-control-sm">
                        <label>Harga</label>
                        <input type="text" id="hargaPrint" class="form-control form-control-sm">
						<br/>
						<button type="submit" id="tambahPrint" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> Tambah</button>
