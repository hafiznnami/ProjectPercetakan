			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Tambah Banner <small>Percetakan Kieta</small>
                        </h1>
                        <div class="panel panel-default">
					<div class="panel-body">
						<label>ID</label>
						<input type="text" id="idBanner" class="form-control form-control-sm">
						<label>Produk</label>
						<input type="text" id="idProduk" class="form-control form-control-sm">
						<label>Bahan</label>
						<input type="text" id="bahanBanner" class="form-control form-control-sm">
                        <label>Ukuran</label>
                        <input type="text" id="ukuranBanner" class="form-control form-control-sm">
						<label>Harga</label>
                        <input type="text" id="hargaBanner" class="form-control form-control-sm">
						<br/>
						<button type="submit" id="tambahBanner" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> Tambah</button>
