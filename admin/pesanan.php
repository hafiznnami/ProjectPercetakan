            ...
            <div id="page-inner">
			 <div class="row">
                    <h1 class="page-header">
                            Pemesanan <small>Percetakan Kieta</small>
                        </h1>
                <div class="col-md-12">
                        <div class="table-responsive">
                            <h1><small>Pemesanan Print</small></h1><br>
                            <div id="print"></div>
                            <h1><small>Pemesanan Brosur</small></h1><br>
                            <div id="brosur"></div>
                            <h1><small>Pemesanan Flyer dan Poster</small></h1><br>
                            <div id="cetakertas"></div>
                            <h1><small>Pemesanan Spanduk dan X-Banner</small></h1><br>
                            <div id="cetakbanner"></div>
                        </div>      
                     </div>
                    </div> 
                 <!-- /. ROW  -->
