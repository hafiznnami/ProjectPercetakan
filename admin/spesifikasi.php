            ...
            <div id="page-inner">
			 <div class="row">
                    <h1 class="page-header">
                            Spesifikasi Barang <small>Percetakan Kieta</small>
                        </h1>
                <div class="col-md-12">
                        <div class="table-responsive">
                            <h1><small>Kertas Print</small></h1><br>
                            <a class="btn btn-primary btn-sm" href="tambahPrint.php"
                                role="button"><i class="glyphicon glyphicon-plus"></i> Tambah Data</a>  
                           <div id="kertas_print"></div>
                           <h1><small>Kertas Brosur, Flyer, dan Poster</small></h1><br>
                            <a class="btn btn-primary btn-sm" href="tambahKertas.php"
                                role="button"><i class="glyphicon glyphicon-plus"></i> Tambah Data</a>
                           <div id="kertas"></div>
                           <h1><small>Banner</small></h1><br>
                            <a class="btn btn-primary btn-sm" href="tambahBanner.php"
                                role="button"><i class="glyphicon glyphicon-plus"></i> Tambah Data</a>
                           <div id="banner"></div>
                        </div>      
                     </div>
