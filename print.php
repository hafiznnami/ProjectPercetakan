<?php
  ...
  $query = mysqli_query($conn, "SELECT * FROM kertas_print WHERE nama_produk = 'print'");
  $queryA4 = mysqli_query($conn, "SELECT * FROM kertas_print WHERE ukuran_kertas = 'Kertas A4'");
  $queryA3 = mysqli_query($conn, "SELECT * FROM kertas_print WHERE ukuran_kertas = 'Kertas A3'");
...
<html lang="en">
  ...
  <body>
    ...
    <!-- Akhir Navbar -->
       ...
       <!-- Jumbotron -->
      <div class="jumbotron jumbotron6 jumbotron-fluid">
        <div class="container">
        </div>
      </div>
    <!-- Akhir Jumbotron -->
    ...
    <!-- Form -->
        <div class="container">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              ...
              <select id="inputUkuran" class="form-control" name="ukuranKertas">
                <option selected value="0">Pilih...</option>
                 <option value="<?=$row4['harga_kertas'];?>" id="kertasA4">Kertas A4</option>
                 <option value="<?=$row3['harga_kertas'];?>" id="kertasA3">Kertas A3</option>
              </select>
            </div>
            <div class="form-group col-md-2">
              <label for="inputBw">Black</label>
              <input type="text" class="form-control" id="inputBw" name="bw">
            </div>
            <div class="form-group col-md-2">
            ...
            <div class="form-group col-md-4">
              <label for="inputPrintSide">Print Side</label>
              <select id="inputPrintSide" class="form-control" name="jumlahSisi">
                <option selected value="0">Pilih...</option>
                <option>1</option>
                <option>2</option>
              </select>
            ...
            <div class="form-group col-md-4">
              <label for="inputJilid">Jilid</label>
              <select id="inputJilid" class="form-control" name="jilid">
                <option selected value="0">Pilih...</option>
                <option value="0">Tidak dijilid</option>
                <option value="3000">Jilid</option>
              </select>
            </div>
            <div class="form-group col-md-4">
              <label for="inputHarga">Total Harga</label>
              <input type="text" class="form-control" id="inputHarga" name="totalHarga" readonly>
            </div>
              <div class="form-group col-md-4">
                <label for="inputPesan">Catatan</label>
                <textarea id="inputPesan" class="form-control" name="message" placeholder="Maksimal 100 Karakter"></textarea>
              </div>
              <div class="form-group col-md-4">
                <label for="inputFile">Masukkan File</label>
                <input type="file" class="form-control-file" id="inputFile" name="dokumen">
              </div>
            </div>
          <button type="submit" class="btn btn-primary tombol" name="pesan">Pesan</button>
          <button type="submit" class="btn btn-primary tombol" id="cekTotal">Cek Total</button>
