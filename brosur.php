...
session_start();
  ...
  $query = mysqli_query($conn, "SELECT * FROM kertas WHERE nama_produk = 'brosur'");
  $queryA4 = mysqli_query($conn, "SELECT * FROM kertas WHERE ukuran_kertas = 'Kertas A4'");
  $queryA3 = mysqli_query($conn, "SELECT * FROM kertas WHERE ukuran_kertas = 'Kertas A3'");
  $query1 = mysqli_query($conn, "SELECT * FROM kertas WHERE id_kertas = '1'");
  $query2 = mysqli_query($conn, "SELECT * FROM kertas WHERE id_kertas = '2'");

  $row = mysqli_fetch_assoc($query);
  $row4 = mysqli_fetch_assoc($queryA4);
  $row3 = mysqli_fetch_assoc($queryA3);
        ...
        <div class="container">
          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data">
              ...
              <input type="hidden" name="produk" id="produk" value="<?=$row['nama_produk'];?>">
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              <label for="inputUkuran">Ukuran Kertas</label>
              <select id="inputUkuran" class="form-control" name="ukuranKertas">
                <option selected value="0" id="Ukurankertas">Pilih...</option>
                 <option value="<?=$row4["ukuran_kertas"];?>" id="kertasA4">Kertas A4</option>
                 <option value="<?=$row3["ukuran_kertas"];?>" id="kertasA3">Kertas A3</option>
              </select>
            </div>
            <div class="form-group col-md-4">
              <label for="inputJenisKertas">Jenis Kertas</label>
              <select id="inputJenisKertas" class="form-control" name="jenisKertas">
                <option selected>Pilih...</option>
                <option value="<?=$row1["jenis_kertas"]?>">Art Paper 120 GSM</option>
                <option value="<?=$row2["jenis_kertas"]?>">Art Paper 150 GSM</option>
              </select>
            </div>
            <div class="form-group col-md-4">
              <label for="inputJumlahSisi">Jumlah Sisi</label>
              <select id="inputJumlahSisi" class="form-control" name="jumlahSisi">
            ...
            <div class="form-group col-md-4">
              <label for="inputLipatan">Lipatan</label>
              <select id="inputLipatan" class="form-control" name="lipatan">
                <option selected>Pilih...</option>
                <option value="Tidak dilipat">Tidak dilipat</option>
                <option value="Dua Lipatan">Dua Lipatan</option>
                <option value="Tiga Lipatan">Tiga Lipatan</option>
              </select>
            </div>
            <div class="form-group col-md-4">
            ...
            <div class="form-group col-md-4">
              ...
              <div class="form-group col-md-2">
                <label for="exampleFormControlFile1">Gambar Depan</label>
                <input type="file" class="form-control-file" id="exampleFormControlFile1" name="gambarDepan">
              </div>
              <div class="form-group col-md-2">
                <label for="exampleFormControlFile2">Gambar Belakang</label>
                <input type="file" class="form-control-file" id="exampleFormControlFile2" name="gambarBelakang">
              </div>
            </div>
          <button type="submit" class="btn btn-primary tombol" name="pesan">Pesan</button>
          <button type="submit" class="btn btn-primary tombol" id="cekHarga">Cek Harga</button>
