...
session_start();
  ...
  $id = $_GET["id"];
  $query = mysqli_query($conn, "SELECT * FROM cetak_banner WHERE id_cetakbanner = '$id'" );
            ...
            <div class="card-body">
              <form method="post" action="">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inputPesanan" name="Id" value="<?=$row['id_cetakbanner']?>" readonly>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inputDesc" name="Desc" value="<?=$row['pesanan_cetakbanner'];?>, <?=$row['nama_produk'];?>, <?=$row['ukuran_cetakbanner'];?>, <?=$row['bahan_cetakbanner'];?>, <?=$row['jumlah_cetakbanner'];?>" readonly>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="Total" id="inputHarga" value="<?=$row['harga_cetakbanner']?>" readonly>
                  </div>        
                  <div class="form-group">
