...
session_start();
  ...
  $id = $_GET["id"];
  $query = mysqli_query($conn, "SELECT * FROM print WHERE id_print = '$id'" );
            ...
            <div class="card-body">
              <form method="post" action="">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inputPesanan" name="Id" value="<?=$row['id_print']?>" readonly>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inputDesc" name="Desc" value="<?=$row['pesanan_print'];?>, <?=$row['nama_produk'];?>, <?=$row['ukuran_print'];?>, <?=$row['black_print'];?>, <?=$row['color_print'];?>, <?=$row['sisi_print'];?>, <?=$row['jilid_print'];?>" readonly>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="Total" id="inputHarga" value="<?=$row['harga_print']?>" readonly>
                  </div>        
                  <div class="form-group">
