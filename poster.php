...
session_start();
  ...
  $query = mysqli_query($conn,"SELECT * FROM kertas WHERE nama_produk = 'poster'");
  ...
  <body>
    ...
    <!-- Form -->
        <div class="container">
            ...
            <div class="form-group col-md-4">
              ...
              <select id="inputUkuran" class="form-control" name="ukuranKertas">
                <option selected value="0" id="Ukurankertas">Pilih...</option>
                 <option value="Kertas A4" id="kertasA4">Kertas A4</option>
                 <option value="Kertas A3" id="kertasA3">Kertas A3</option>
              </select>
            </div>
            <div class="form-group col-md-4">
              ...
              <select id="inputJenisKertas" class="form-control" name="jenisKertas">
                ...
                <option value="Art Cartoon 260 GSM">Art Cartoon 260 GSM</option>
              </select>
            </div>
            <div class="form-group col-md-4">
          ...
          <button type="submit" class="btn btn-primary tombol" id="cekHarga2">Cek Harga</button>
        </form>
      </header>
    </div>
  </div>
