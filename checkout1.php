...
session_start();
  ...
  $id = $_GET["id"];
  $query = mysqli_query($conn, "SELECT * FROM brosur WHERE id_brosur = '$id'" );
            ...
            <div class="card-body">
              <form method="post" action="">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inputPesanan" name="Id" value="<?=$row['id_brosur']?>" readonly>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inputDesc" name="Desc" value="<?=$row['pesanan_brosur'];?>, <?=$row['nama_produk'];?>, <?=$row['ukuran_brosur'];?>, <?=$row['kertas_brosur'];?>, <?=$row['sisi_brosur'];?>, <?=$row['lipatan_brosur'];?>, <?=$row['jumlah_brosur'];?>" readonly>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="Total" id="inputHarga" value="<?=$row['harga_brosur']?>" readonly>
                  </div>        
                  <div class="form-group">
