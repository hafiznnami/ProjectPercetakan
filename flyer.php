...
session_start();
  ...
  $query = mysqli_query($conn,"SELECT * FROM kertas WHERE nama_produk = 'flyer'");
  ...
  <body>
    ...
    <!-- Form -->
        <div class="container">
            ...
            <div class="form-group col-md-4">
              ...
              <select id="inputUkuran" class="form-control" name="ukuranKertas">
                <option selected value="0" id="Ukurankertas">Pilih...</option>
                 ...
                 <option value="Kertas A5" id="kertasA5">Kertas A5</option>
                 <option value="Kertas A6" id="kertasA6">Kertas A6</option>
              </select>
            </div>
            <div class="form-group col-md-4">
          ...
          <button type="submit" class="btn btn-primary tombol" id="cekHarga1">Cek Harga</button>
        </form>
      </header>
    </div>
  </div>
