...
session_start();
  ...
  $query1 = mysqli_query($conn,"SELECT * FROM banner WHERE ukuran_banner = '100 x 100 cm'");
  $query2 = mysqli_query($conn,"SELECT * FROM banner WHERE ukuran_banner = '150 x 100 cm'");
  $query3 = mysqli_query($conn,"SELECT * FROM banner WHERE ukuran_banner = '200 x 100 cm'");
  $query4 = mysqli_query($conn,"SELECT * FROM banner WHERE ukuran_banner = '300 x 100 cm'");
  $query5 = mysqli_query($conn,"SELECT * FROM banner WHERE ukuran_banner = '400 x 100 cm'");
  $query6 = mysqli_query($conn,"SELECT * FROM banner WHERE ukuran_banner = '500 x 100 cm'");
  $query7 = mysqli_query($conn,"SELECT * FROM banner WHERE nama_produk = 'spanduk'");
...
<html lang="en">
  ...
  <body>
    ...
    <!-- Akhir Navbar -->
       ...
       <!-- Jumbotron -->
      <div class="jumbotron jumbotron5 jumbotron-fluid">
        <div class="container">
        </div>
      </div>
    <!-- Akhir Jumbotron -->
        ...
        <div class="container">
          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data">
              ...
              <input type="hidden" name="produk" id="produk" value="<?=$row7['nama_produk'];?>">
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              ...
              <select id="inputUkuran" class="form-control" name="ukuranBanner">
                ...
                <option value="<?=$row1['harga_banner'];?>">100 x 100 cm</option>
                <option value="<?=$row2['harga_banner'];?>">150 x 100 cm</option>
                <option value="<?=$row3['harga_banner'];?>">200 x 100 cm</option>
                <option value="<?=$row4['harga_banner'];?>">300 x 100 cm</option>
                <option value="<?=$row5['harga_banner'];?>">400 x 100 cm</option>
                <option value="<?=$row6['harga_banner'];?>">500 x 100 cm</option>
              </select>
            </div>
            <div class="form-group col-md-4">
          ...
          <button type="submit" class="btn btn-primary tombol" id="cekHarga4">Cek Harga</button>
        </form>
      </header>
    </div>
  </div>
